# -*- coding: utf-8 -*-
"""
Created on Wed Mar 29 15:01:57 2023

@author: deepology
"""

""" A Tensorflow keras implementation for the paper titled `A ConvNet for the 2020s`  -
...
class ConvNeXtBlock(Layer):
    r""" ConvNeXt Block. Two ways to implement this block:
    First: DwConv -> Permute to (N, H, W, C); LayerNorm (channels_last) -> Linear -> GELU -> Linear; Permute back
    Second: DwConv -> LayerNorm (channels_first) -> 1x1 Conv -> GELU -> 1x1 Conv; all in (N, C, H, W)
    
    The first way is used here
